...
export default defineConfig({
  // Use the appropriate schema for the detected dialect
  schema: databaseUrl && databaseUrl.startsWith("postgresql://")
    ? "./src/db/schema-postgres.ts"
    : "./src/db/schema.ts",
  out: databaseUrl && databaseUrl.startsWith("postgresql://")
    ? "./drizzle-postgres"
    : "./drizzle",
  dialect: databaseUrl && databaseUrl.startsWith("postgresql://")
    ? "postgresql"
    : "sqlite",
  dbCredentials:
